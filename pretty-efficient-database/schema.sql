...
-- Consultations (pre-job paid meetings, can link to a lead or an existing client)
create table consultations (
  ...
  status text not null default 'Scheduled', -- Scheduled, Completed, No-Show, Declined, Converted
  notes text,
